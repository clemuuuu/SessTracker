...
export function BackgroundTree() {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            // Helper for gradients (Simulating 3D cylinders)
            ...
            const drawOrganicBranch = (
                ...
                // ... (State determination remains same)
                let isActive = false;
                if (nodeId === 'VIRTUAL_ROOT') {
                    isActive = activeNodeId !== null;
                } else {
                    isActive = nodeId === activeNodeId || activeAncestorIds.includes(nodeId);
                }
