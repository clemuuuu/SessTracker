...
- [x] **TREE-01**: The 2D tree is redrawn with organic curves and a polished visual style
...
- [x] **TREE-04**: Active branch and ancestors have a rich lighting system (pulsing glow, radial gradients, not just shadowBlur)
